...
```bash
INIT=$(node "/home/xsma/Documents/SITAB/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/xsma/Documents/SITAB/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
