...
- **Global scope**: `/home/xsma/Documents/SITAB/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/xsma/Documents/SITAB/.claude/notes/`)
...
2. Glob `/home/xsma/Documents/SITAB/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/xsma/Documents/SITAB/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/xsma/Documents/SITAB/.claude/notes/` — works in any directory
