...
```
Agent(
  prompt="Read /home/xsma/Documents/SITAB/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/xsma/Documents/SITAB/.claude/get-shit-done/templates/SECURITY.md`
