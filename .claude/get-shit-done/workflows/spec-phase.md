...
```bash
INIT=$(node "/home/xsma/Documents/SITAB/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/xsma/Documents/SITAB/.claude/get-shit-done/templates/spec.md.
