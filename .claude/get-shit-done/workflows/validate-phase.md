...
```
Agent(
  prompt="Read /home/xsma/Documents/SITAB/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/xsma/Documents/SITAB/.claude/get-shit-done/templates/VALIDATION.md`
