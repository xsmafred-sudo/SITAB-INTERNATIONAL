        ...
        <div className="p-6 bg-background/50 backdrop-blur-md border-t border-foreground/5 mt-auto shrink-0">
          ...
          >
            <a 
              ...
              className={cn(
                buttonVariants(),
                "w-full bg-[#25D366] hover:bg-[#20ba5a] text-white border-0 h-12 rounded-2xl shadow-lg shadow-[#25D366]/20 transition-all active:scale-[0.98] flex items-center justify-center gap-2"
              )}
            >
